...
public class ExceptionHandlerImpl extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> handleFileStorageExceptions(
    ...
    public final ResponseEntity<Object> handleAWSUploadException(
      AWSUploadException ex) {
      String string = "AWS %s \n";
      String exceptionResponse = String.format(string, ex.getMessage());
      return new ResponseEntity<>(exceptionResponse, HttpStatus.BAD_REQUEST);
    }
    ...
    public final ResponseEntity<Object> handleNotSupportedException(
